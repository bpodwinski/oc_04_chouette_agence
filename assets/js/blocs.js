  ...
  $(".navbar-toggle").click(function (t) {
    ...
    if (i.parent().hasClass("nav-special"))
      if ((t.stopPropagation(), $(this).hasClass("selected-nav")))
        ...
        let o = e.attr("class").replace("navbar", "").replace("row", ""),
          l = i
            .parent()
            .attr("class")
...
function setUpDropdownSubs() {
  $("ul.dropdown-menu [data-toggle=dropdown]").on("click", function (t) {
    ...
    let e = $(this).parent().children(".dropdown-menu");
...
function stickyNavToggle() {
  ...
  if ($(".sticky-nav").hasClass("fill-bloc-top-edge")) {
    let i = $(".fill-bloc-top-edge.sticky-nav")
      .parent()
...
function inViewCheck() {
  $($(".hideMe").get().reverse()).each(function (t) {
    ...
    if ((e.height() > $(window).height() && (i = e.offset().top), i < a)) {
      let o = e.attr("class").replace("hideMe", "animated");
...
function setUpVisibilityToggle() {
  $(document).on("click", "[data-toggle-visibility]", function (t) {
    t.preventDefault();
    let e = $(this).attr("data-toggle-visibility");
    if (-1 != e.indexOf(",")) {
      let i = e.split(",");
      $.each(i, function (t) {
        a($("#" + i[t]));
  ...
  window.targetLightbox,
    $(document)
      .on("click", "[data-lightbox]", function (t) {
        ...
        let e = targetLightbox.attr("data-lightbox"),
